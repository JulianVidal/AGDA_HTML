...
% \todo[inline]{Should I explain the HTML files, as I am not using them but they were explore}
% \todo[inline]{Moved the fialed attempt to the evaluation, explain why
% s-experssion was a better approach}
% At first, HTML files that Agda generates were explored. These HTML files
...
\todo[inline]{format sexp-1, sexp-n in a good way?}
...
\todo[inline]{How to format :tags, using textsf?}
...
The CLI parameters are stored in sys.argv, argparse parses it based on the
...
\todo[inline]{Is it good to show the help?}
...
\todo[inline]{Should I explain agda tree installation, it is part of the requirements}
...
\todo[inline]{Do I need to show code?}
...
\todo[inline]{how to format these file names}
...
\todo[inline]{Is this help necessary}
...
\todo[inline]{format files and directories}
...
\todo[inline]{format cli commansd}
