...
of projects regardless of size. To not disrupt the developer, the queries must
respond in less than 1 second. Agda is used mainly in Unix-based systems, so this tool must
