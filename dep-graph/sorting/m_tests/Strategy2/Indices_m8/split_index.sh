#!/bin/zsh
    ...
    if [ -f ./index-0-4.lagda ]; then
        agda ./index-0-4.lagda &
    elif [ -f ./index-0-4.agda ]; then
        agda ./index-0-4.agda &
    else
      printf 'File index-0-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-1-5.lagda ]; then
        agda ./index-1-5.lagda &
    elif [ -f ./index-1-5.agda ]; then
        agda ./index-1-5.agda &
    else
      printf 'File index-1-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-1-6.lagda ]; then
        agda ./index-1-6.lagda &
    elif [ -f ./index-1-6.agda ]; then
        agda ./index-1-6.agda &
    else
      printf 'File index-1-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-1-7.lagda ]; then
        agda ./index-1-7.lagda &
    elif [ -f ./index-1-7.agda ]; then
        agda ./index-1-7.agda &
    else
      printf 'File index-1-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-2-4.lagda ]; then
        agda ./index-2-4.lagda &
    elif [ -f ./index-2-4.agda ]; then
        agda ./index-2-4.agda &
    else
      printf 'File index-2-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-2-5.lagda ]; then
        agda ./index-2-5.lagda &
    elif [ -f ./index-2-5.agda ]; then
        agda ./index-2-5.agda &
    else
      printf 'File index-2-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-2-6.lagda ]; then
        agda ./index-2-6.lagda &
    elif [ -f ./index-2-6.agda ]; then
        agda ./index-2-6.agda &
    else
      printf 'File index-2-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-2-7.lagda ]; then
        agda ./index-2-7.lagda &
    elif [ -f ./index-2-7.agda ]; then
        agda ./index-2-7.agda &
    else
      printf 'File index-2-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-4-4.lagda ]; then
        agda ./index-4-4.lagda &
    elif [ -f ./index-4-4.agda ]; then
        agda ./index-4-4.agda &
    else
      printf 'File index-4-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-4-5.lagda ]; then
        agda ./index-4-5.lagda &
    elif [ -f ./index-4-5.agda ]; then
        agda ./index-4-5.agda &
    else
      printf 'File index-4-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-4-6.lagda ]; then
        agda ./index-4-6.lagda &
    elif [ -f ./index-4-6.agda ]; then
        agda ./index-4-6.agda &
    else
      printf 'File index-4-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-6-4.lagda ]; then
        agda ./index-6-4.lagda &
    elif [ -f ./index-6-4.agda ]; then
        agda ./index-6-4.agda &
    else
      printf 'File index-6-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-6-5.lagda ]; then
        agda ./index-6-5.lagda &
    elif [ -f ./index-6-5.agda ]; then
        agda ./index-6-5.agda &
    else
      printf 'File index-6-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-6-6.lagda ]; then
        agda ./index-6-6.lagda &
    elif [ -f ./index-6-6.agda ]; then
        agda ./index-6-6.agda &
    else
      printf 'File index-6-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-6-7.lagda ]; then
        agda ./index-6-7.lagda &
    elif [ -f ./index-6-7.agda ]; then
        agda ./index-6-7.agda &
    else
      printf 'File index-6-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-8-4.lagda ]; then
        agda ./index-8-4.lagda &
    elif [ -f ./index-8-4.agda ]; then
        agda ./index-8-4.agda &
    else
      printf 'File index-8-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-8-5.lagda ]; then
        agda ./index-8-5.lagda &
    elif [ -f ./index-8-5.agda ]; then
        agda ./index-8-5.agda &
    else
      printf 'File index-8-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-8-6.lagda ]; then
        agda ./index-8-6.lagda &
    elif [ -f ./index-8-6.agda ]; then
        agda ./index-8-6.agda &
    else
      printf 'File index-8-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-8-7.lagda ]; then
        agda ./index-8-7.lagda &
    elif [ -f ./index-8-7.agda ]; then
        agda ./index-8-7.agda &
    else
      printf 'File index-8-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-9-7.lagda ]; then
        agda ./index-9-7.lagda &
    elif [ -f ./index-9-7.agda ]; then
        agda ./index-9-7.agda &
    else
      printf 'File index-9-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-10-4.lagda ]; then
        agda ./index-10-4.lagda &
    elif [ -f ./index-10-4.agda ]; then
        agda ./index-10-4.agda &
    else
      printf 'File index-10-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-10-5.lagda ]; then
        agda ./index-10-5.lagda &
    elif [ -f ./index-10-5.agda ]; then
        agda ./index-10-5.agda &
    else
      printf 'File index-10-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-10-6.lagda ]; then
        agda ./index-10-6.lagda &
    elif [ -f ./index-10-6.agda ]; then
        agda ./index-10-6.agda &
    else
      printf 'File index-10-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-10-7.lagda ]; then
        agda ./index-10-7.lagda &
    elif [ -f ./index-10-7.agda ]; then
        agda ./index-10-7.agda &
    else
      printf 'File index-10-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-11-7.lagda ]; then
        agda ./index-11-7.lagda &
    elif [ -f ./index-11-7.agda ]; then
        agda ./index-11-7.agda &
    else
      printf 'File index-11-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-12-4.lagda ]; then
        agda ./index-12-4.lagda &
    elif [ -f ./index-12-4.agda ]; then
        agda ./index-12-4.agda &
    else
      printf 'File index-12-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-12-5.lagda ]; then
        agda ./index-12-5.lagda &
    elif [ -f ./index-12-5.agda ]; then
        agda ./index-12-5.agda &
    else
      printf 'File index-12-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-12-6.lagda ]; then
        agda ./index-12-6.lagda &
    elif [ -f ./index-12-6.agda ]; then
        agda ./index-12-6.agda &
    else
      printf 'File index-12-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-12-7.lagda ]; then
        agda ./index-12-7.lagda &
    elif [ -f ./index-12-7.agda ]; then
        agda ./index-12-7.agda &
    else
      printf 'File index-12-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-14-4.lagda ]; then
        agda ./index-14-4.lagda &
    elif [ -f ./index-14-4.agda ]; then
        agda ./index-14-4.agda &
    else
      printf 'File index-14-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-14-5.lagda ]; then
        agda ./index-14-5.lagda &
    elif [ -f ./index-14-5.agda ]; then
        agda ./index-14-5.agda &
    else
      printf 'File index-14-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-14-6.lagda ]; then
        agda ./index-14-6.lagda &
    elif [ -f ./index-14-6.agda ]; then
        agda ./index-14-6.agda &
    else
      printf 'File index-14-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-14-7.lagda ]; then
        agda ./index-14-7.lagda &
    elif [ -f ./index-14-7.agda ]; then
        agda ./index-14-7.agda &
    else
      printf 'File index-14-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-16-4.lagda ]; then
        agda ./index-16-4.lagda &
    elif [ -f ./index-16-4.agda ]; then
        agda ./index-16-4.agda &
    else
      printf 'File index-16-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-16-5.lagda ]; then
        agda ./index-16-5.lagda &
    elif [ -f ./index-16-5.agda ]; then
        agda ./index-16-5.agda &
    else
      printf 'File index-16-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-16-6.lagda ]; then
        agda ./index-16-6.lagda &
    elif [ -f ./index-16-6.agda ]; then
        agda ./index-16-6.agda &
    else
      printf 'File index-16-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-16-7.lagda ]; then
        agda ./index-16-7.lagda &
    elif [ -f ./index-16-7.agda ]; then
        agda ./index-16-7.agda &
    else
      printf 'File index-16-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-20-4.lagda ]; then
        agda ./index-20-4.lagda &
    elif [ -f ./index-20-4.agda ]; then
        agda ./index-20-4.agda &
    else
      printf 'File index-20-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-22-4.lagda ]; then
        agda ./index-22-4.lagda &
    elif [ -f ./index-22-4.agda ]; then
        agda ./index-22-4.agda &
    else
      printf 'File index-22-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-22-5.lagda ]; then
        agda ./index-22-5.lagda &
    elif [ -f ./index-22-5.agda ]; then
        agda ./index-22-5.agda &
    else
      printf 'File index-22-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-22-6.lagda ]; then
        agda ./index-22-6.lagda &
    elif [ -f ./index-22-6.agda ]; then
        agda ./index-22-6.agda &
    else
      printf 'File index-22-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-22-7.lagda ]; then
        agda ./index-22-7.lagda &
    elif [ -f ./index-22-7.agda ]; then
        agda ./index-22-7.agda &
    else
      printf 'File index-22-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-26-4.lagda ]; then
        agda ./index-26-4.lagda &
    elif [ -f ./index-26-4.agda ]; then
        agda ./index-26-4.agda &
    else
      printf 'File index-26-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-26-5.lagda ]; then
        agda ./index-26-5.lagda &
    elif [ -f ./index-26-5.agda ]; then
        agda ./index-26-5.agda &
    else
      printf 'File index-26-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-26-6.lagda ]; then
        agda ./index-26-6.lagda &
    elif [ -f ./index-26-6.agda ]; then
        agda ./index-26-6.agda &
    else
      printf 'File index-26-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-26-7.lagda ]; then
        agda ./index-26-7.lagda &
    elif [ -f ./index-26-7.agda ]; then
        agda ./index-26-7.agda &
    else
      printf 'File index-26-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-28-4.lagda ]; then
        agda ./index-28-4.lagda &
    elif [ -f ./index-28-4.agda ]; then
        agda ./index-28-4.agda &
    else
      printf 'File index-28-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-28-5.lagda ]; then
        agda ./index-28-5.lagda &
    elif [ -f ./index-28-5.agda ]; then
        agda ./index-28-5.agda &
    else
      printf 'File index-28-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-28-6.lagda ]; then
        agda ./index-28-6.lagda &
    elif [ -f ./index-28-6.agda ]; then
        agda ./index-28-6.agda &
    else
      printf 'File index-28-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-28-7.lagda ]; then
        agda ./index-28-7.lagda &
    elif [ -f ./index-28-7.agda ]; then
        agda ./index-28-7.agda &
    else
      printf 'File index-28-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-30-4.lagda ]; then
        agda ./index-30-4.lagda &
    elif [ -f ./index-30-4.agda ]; then
        agda ./index-30-4.agda &
    else
      printf 'File index-30-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-30-5.lagda ]; then
        agda ./index-30-5.lagda &
    elif [ -f ./index-30-5.agda ]; then
        agda ./index-30-5.agda &
    else
      printf 'File index-30-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-30-6.lagda ]; then
        agda ./index-30-6.lagda &
    elif [ -f ./index-30-6.agda ]; then
        agda ./index-30-6.agda &
    else
      printf 'File index-30-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-30-7.lagda ]; then
        agda ./index-30-7.lagda &
    elif [ -f ./index-30-7.agda ]; then
        agda ./index-30-7.agda &
    else
      printf 'File index-30-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-32-4.lagda ]; then
        agda ./index-32-4.lagda &
    elif [ -f ./index-32-4.agda ]; then
        agda ./index-32-4.agda &
    else
      printf 'File index-32-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-32-5.lagda ]; then
        agda ./index-32-5.lagda &
    elif [ -f ./index-32-5.agda ]; then
        agda ./index-32-5.agda &
    else
      printf 'File index-32-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-32-6.lagda ]; then
        agda ./index-32-6.lagda &
    elif [ -f ./index-32-6.agda ]; then
        agda ./index-32-6.agda &
    else
      printf 'File index-32-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-32-7.lagda ]; then
        agda ./index-32-7.lagda &
    elif [ -f ./index-32-7.agda ]; then
        agda ./index-32-7.agda &
    else
      printf 'File index-32-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-34-4.lagda ]; then
        agda ./index-34-4.lagda &
    elif [ -f ./index-34-4.agda ]; then
        agda ./index-34-4.agda &
    else
      printf 'File index-34-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-34-5.lagda ]; then
        agda ./index-34-5.lagda &
    elif [ -f ./index-34-5.agda ]; then
        agda ./index-34-5.agda &
    else
      printf 'File index-34-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-34-6.lagda ]; then
        agda ./index-34-6.lagda &
    elif [ -f ./index-34-6.agda ]; then
        agda ./index-34-6.agda &
    else
      printf 'File index-34-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-34-7.lagda ]; then
        agda ./index-34-7.lagda &
    elif [ -f ./index-34-7.agda ]; then
        agda ./index-34-7.agda &
    else
      printf 'File index-34-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-36-4.lagda ]; then
        agda ./index-36-4.lagda &
    elif [ -f ./index-36-4.agda ]; then
        agda ./index-36-4.agda &
    else
      printf 'File index-36-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-36-5.lagda ]; then
        agda ./index-36-5.lagda &
    elif [ -f ./index-36-5.agda ]; then
        agda ./index-36-5.agda &
    else
      printf 'File index-36-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-36-6.lagda ]; then
        agda ./index-36-6.lagda &
    elif [ -f ./index-36-6.agda ]; then
        agda ./index-36-6.agda &
    else
      printf 'File index-36-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-36-7.lagda ]; then
        agda ./index-36-7.lagda &
    elif [ -f ./index-36-7.agda ]; then
        agda ./index-36-7.agda &
    else
      printf 'File index-36-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-37-4.lagda ]; then
        agda ./index-37-4.lagda &
    elif [ -f ./index-37-4.agda ]; then
        agda ./index-37-4.agda &
    else
      printf 'File index-37-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-37-5.lagda ]; then
        agda ./index-37-5.lagda &
    elif [ -f ./index-37-5.agda ]; then
        agda ./index-37-5.agda &
    else
      printf 'File index-37-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-37-6.lagda ]; then
        agda ./index-37-6.lagda &
    elif [ -f ./index-37-6.agda ]; then
        agda ./index-37-6.agda &
    else
      printf 'File index-37-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-37-7.lagda ]; then
        agda ./index-37-7.lagda &
    elif [ -f ./index-37-7.agda ]; then
        agda ./index-37-7.agda &
    else
      printf 'File index-37-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-38-4.lagda ]; then
        agda ./index-38-4.lagda &
    elif [ -f ./index-38-4.agda ]; then
        agda ./index-38-4.agda &
    else
      printf 'File index-38-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-38-5.lagda ]; then
        agda ./index-38-5.lagda &
    elif [ -f ./index-38-5.agda ]; then
        agda ./index-38-5.agda &
    else
      printf 'File index-38-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-38-6.lagda ]; then
        agda ./index-38-6.lagda &
    elif [ -f ./index-38-6.agda ]; then
        agda ./index-38-6.agda &
    else
      printf 'File index-38-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-38-7.lagda ]; then
        agda ./index-38-7.lagda &
    elif [ -f ./index-38-7.agda ]; then
        agda ./index-38-7.agda &
    else
      printf 'File index-38-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-39-5.lagda ]; then
        agda ./index-39-5.lagda &
    elif [ -f ./index-39-5.agda ]; then
        agda ./index-39-5.agda &
    else
      printf 'File index-39-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-39-6.lagda ]; then
        agda ./index-39-6.lagda &
    elif [ -f ./index-39-6.agda ]; then
        agda ./index-39-6.agda &
    else
      printf 'File index-39-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-39-7.lagda ]; then
        agda ./index-39-7.lagda &
    elif [ -f ./index-39-7.agda ]; then
        agda ./index-39-7.agda &
    else
      printf 'File index-39-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-40-4.lagda ]; then
        agda ./index-40-4.lagda &
    elif [ -f ./index-40-4.agda ]; then
        agda ./index-40-4.agda &
    else
      printf 'File index-40-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-40-5.lagda ]; then
        agda ./index-40-5.lagda &
    elif [ -f ./index-40-5.agda ]; then
        agda ./index-40-5.agda &
    else
      printf 'File index-40-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-40-6.lagda ]; then
        agda ./index-40-6.lagda &
    elif [ -f ./index-40-6.agda ]; then
        agda ./index-40-6.agda &
    else
      printf 'File index-40-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-40-7.lagda ]; then
        agda ./index-40-7.lagda &
    elif [ -f ./index-40-7.agda ]; then
        agda ./index-40-7.agda &
    else
      printf 'File index-40-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-41-5.lagda ]; then
        agda ./index-41-5.lagda &
    elif [ -f ./index-41-5.agda ]; then
        agda ./index-41-5.agda &
    else
      printf 'File index-41-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-41-6.lagda ]; then
        agda ./index-41-6.lagda &
    elif [ -f ./index-41-6.agda ]; then
        agda ./index-41-6.agda &
    else
      printf 'File index-41-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-41-7.lagda ]; then
        agda ./index-41-7.lagda &
    elif [ -f ./index-41-7.agda ]; then
        agda ./index-41-7.agda &
    else
      printf 'File index-41-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-42-4.lagda ]; then
        agda ./index-42-4.lagda &
    elif [ -f ./index-42-4.agda ]; then
        agda ./index-42-4.agda &
    else
      printf 'File index-42-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-42-5.lagda ]; then
        agda ./index-42-5.lagda &
    elif [ -f ./index-42-5.agda ]; then
        agda ./index-42-5.agda &
    else
      printf 'File index-42-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-42-6.lagda ]; then
        agda ./index-42-6.lagda &
    elif [ -f ./index-42-6.agda ]; then
        agda ./index-42-6.agda &
    else
      printf 'File index-42-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-42-7.lagda ]; then
        agda ./index-42-7.lagda &
    elif [ -f ./index-42-7.agda ]; then
        agda ./index-42-7.agda &
    else
      printf 'File index-42-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-44-4.lagda ]; then
        agda ./index-44-4.lagda &
    elif [ -f ./index-44-4.agda ]; then
        agda ./index-44-4.agda &
    else
      printf 'File index-44-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-44-5.lagda ]; then
        agda ./index-44-5.lagda &
    elif [ -f ./index-44-5.agda ]; then
        agda ./index-44-5.agda &
    else
      printf 'File index-44-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-44-6.lagda ]; then
        agda ./index-44-6.lagda &
    elif [ -f ./index-44-6.agda ]; then
        agda ./index-44-6.agda &
    else
      printf 'File index-44-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-44-7.lagda ]; then
        agda ./index-44-7.lagda &
    elif [ -f ./index-44-7.agda ]; then
        agda ./index-44-7.agda &
    else
      printf 'File index-44-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-46-4.lagda ]; then
        agda ./index-46-4.lagda &
    elif [ -f ./index-46-4.agda ]; then
        agda ./index-46-4.agda &
    else
      printf 'File index-46-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-46-5.lagda ]; then
        agda ./index-46-5.lagda &
    elif [ -f ./index-46-5.agda ]; then
        agda ./index-46-5.agda &
    else
      printf 'File index-46-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-46-6.lagda ]; then
        agda ./index-46-6.lagda &
    elif [ -f ./index-46-6.agda ]; then
        agda ./index-46-6.agda &
    else
      printf 'File index-46-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-46-7.lagda ]; then
        agda ./index-46-7.lagda &
    elif [ -f ./index-46-7.agda ]; then
        agda ./index-46-7.agda &
    else
      printf 'File index-46-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-47-5.lagda ]; then
        agda ./index-47-5.lagda &
    elif [ -f ./index-47-5.agda ]; then
        agda ./index-47-5.agda &
    else
      printf 'File index-47-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-47-6.lagda ]; then
        agda ./index-47-6.lagda &
    elif [ -f ./index-47-6.agda ]; then
        agda ./index-47-6.agda &
    else
      printf 'File index-47-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-47-7.lagda ]; then
        agda ./index-47-7.lagda &
    elif [ -f ./index-47-7.agda ]; then
        agda ./index-47-7.agda &
    else
      printf 'File index-47-7 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-48-4.lagda ]; then
        agda ./index-48-4.lagda &
    elif [ -f ./index-48-4.agda ]; then
        agda ./index-48-4.agda &
    else
      printf 'File index-48-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-48-5.lagda ]; then
        agda ./index-48-5.lagda &
    elif [ -f ./index-48-5.agda ]; then
        agda ./index-48-5.agda &
    else
      printf 'File index-48-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-48-6.lagda ]; then
        agda ./index-48-6.lagda &
    elif [ -f ./index-48-6.agda ]; then
        agda ./index-48-6.agda &
    else
      printf 'File index-48-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-49-4.lagda ]; then
        agda ./index-49-4.lagda &
    elif [ -f ./index-49-4.agda ]; then
        agda ./index-49-4.agda &
    else
      printf 'File index-49-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-49-5.lagda ]; then
        agda ./index-49-5.lagda &
    elif [ -f ./index-49-5.agda ]; then
        agda ./index-49-5.agda &
    else
      printf 'File index-49-5 not found' >&2  # write error message to stderr
      exit 1
    fi
    
    if [ -f ./index-49-6.lagda ]; then
        agda ./index-49-6.lagda &
    elif [ -f ./index-49-6.agda ]; then
        agda ./index-49-6.agda &
    else
      printf 'File index-49-6 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
    ...
    if [ -f ./index-50-4.lagda ]; then
        agda ./index-50-4.lagda &
    elif [ -f ./index-50-4.agda ]; then
        agda ./index-50-4.agda &
    else
      printf 'File index-50-4 not found' >&2  # write error message to stderr
      exit 1
    fi
    wait
