...
% This tool would also allow the owner of the project to refactor their
% modules and change the structure of the project based on what the relationship
% between the definition is. For example, if a definition isn't used often, it
% can be removed, if a definition depends on many other definitions it could be
