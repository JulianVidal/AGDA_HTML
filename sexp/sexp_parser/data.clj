...
{:db/id 358 :func/mod 373}
{:db/id 358 :func/dep 365}
{:db/id 358 :func/dep 368}
{:db/id 358 :func/dep 366}
{:db/id 362 :func/def "InfinitePigeon.Naturals.mapsto 120"}
{:db/id 362 :func/mod 373}
{:db/id 362 :func/dep 365}
{:db/id 362 :func/dep 358}
{:db/id 365 :func/def "MLTT.Natural-Numbers-Type.ℕ 4"}
{:db/id 365 :func/mod 372}
{:db/id 366 :func/def "MLTT.Natural-Numbers-Type.ℕ.zero 6"}
{:db/id 366 :func/mod 372}
{:db/id 366 :func/dep 365}
{:db/id 368 :func/def "MLTT.Natural-Numbers-Type.ℕ.succ 8"}
{:db/id 368 :func/mod 372}
{:db/id 368 :func/dep 365}
{:db/id 370 :mod/def "InfinitePigeon.Equality"}
{:db/id 371 :mod/def "InfinitePigeon.LogicalFacts"}
{:db/id 372 :mod/def "MLTT.Natural-Numbers-Type"}
{:db/id 373 :mod/def "InfinitePigeon.Naturals"}
{:db/id 374 :mod/def "Agda.Primitive"}
{:db/id 375 :mod/def "InfinitePigeon.Logic"}
{:db/id 376 :mod/def "InfinitePigeon.Addition"}
])